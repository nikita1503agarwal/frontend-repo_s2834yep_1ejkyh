  ...
  return (
    <section className="relative py-24" id="pricing">
      <div className="max-w-6xl mx-auto px-6">
        <h3 className="text-3xl font-semibold text-white tracking-tight">Simple pricing.</h3>
        <div className="mt-10 grid md:grid-cols-2 gap-6">
          <div className="relative rounded-2xl border border-white/10 bg-white/5 p-6">
            <div className="text-white/80">Pilot Setup</div>
            <div className="mt-1 text-3xl text-white font-semibold">25,000 SEK</div>
            <ul className="mt-4 space-y-2 text-white/80 text-sm">
              <li>Full automation setup</li>
              <li>Custom qualification logic</li>
          ...
          <div className="relative rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-1 text-3xl text-white font-semibold">7,500 SEK</div>
            <ul className="mt-4 space-y-2 text-white/80 text-sm">

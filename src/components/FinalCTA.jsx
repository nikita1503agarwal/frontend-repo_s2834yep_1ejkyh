    ...
    <section className="relative py-24" id="book">
      ...
      <div className="relative max-w-3xl mx-auto text-center px-6">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
          <a href="#contact" className="inline-flex items-center justify-center rounded-lg bg-white text-slate-900 px-5 py-3 font-medium shadow/20 shadow-black/30 hover:shadow-black/40 hover:shadow-lg transition">
            Talk to us
          </a>
          <a href="https://calendly.com/" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-lg border border-white/20 bg-white/5 text-white px-5 py-3 font-medium hover:bg-white/10 transition">
            Book a 10 min intro
          </a>
